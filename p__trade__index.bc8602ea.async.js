...
var Swap = function Swap(_ref) {
  ...
  var outAmountMax = (0,react.useMemo)(function () {}, [outToken]);
      ...
      return regeneratorRuntime_default()().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              if (!(outToken && outToken.id.toLowerCase() === (osdData === null || osdData === void 0 ? void 0 : osdData.id.toLowerCase()))) {
                _context2.next = 4;
                break;
              }
  ...
  var _handelSwitch = function _handelSwitch() {
    var _inToken = inToken;
    var _outToken = outToken;
    var _inAmount = inAmount;
    setInToken(_outToken);
    setOutToken(_inToken);
    setInAmount('');
    setOutAmount(_inAmount);
    handleOutChange();
  };

  var _useDebounceFn3 = (0,useDebounceFn/* default */.Z)(_handelSwitch, {
    wait: 300
  }),
      handelSwitch = _useDebounceFn3.run;
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(spin/* default */.Z, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        onAmountChange: function onAmountChange(value) {
          if ((outToken === null || outToken === void 0 ? void 0 : outToken.id.toLocaleLowerCase()) === (osdData === null || osdData === void 0 ? void 0 : osdData.id.toLowerCase())) {
            setOutAmount('0');
            handleInChange();
          } else {
        ...
        maxValue: outToken && outToken.symbol !== 'OSD' ? Number(Number(poolBalance || '0').toFixed(2)) : Infinity,
        ...
        disabled: outToken && (outToken === null || outToken === void 0 ? void 0 : outToken.id.toLocaleLowerCase()) === (osdData === null || osdData === void 0 ? void 0 : osdData.id.toLowerCase()),
        tokenSelectProps: {
          position: 'swap'
        }
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        conditions: [{
          ...
          condition: parseFloat(impact) > maxSlippage && parseFloat(impact) < 5,
          text: formatMessage({
          ...
          condition: parseFloat(impact) > 5,
          text: formatMessage({
            id: 'Too big slippage, swap a smaller size'
          }),
          type: 'primary',
          danger: true,
          onClick: function onClick() {}
...
// extracted by mini-css-extract-plugin
/* harmony default export */ var TradeHistorymodules = ({"container":"container___WkeWH"});
...
var TradeChartLite = function TradeChartLite(props) {
  ...
  var _useState5 = (0,react.useState)('hours'),
      _useState6 = slicedToArray_default()(_useState5, 2),
      actionType = _useState6[0],
      setActionType = _useState6[1];
  ...
  var config = (0,react.useMemo)(function () {
    return {
      ...
      areaStyle: function areaStyle() {
        return {
          fill: 'l(270) 0:rgba(3, 205, 193, 0)0.3:rgba(3, 205, 193, 0.15)  1:#40d7cd ,'
        };
      }
    };
  ...
  })), [chain, id, tokenDecimal, actionType]);
  var updata = (0,useIntervalAsync/* default */.Z)(fetchChartData, 300000);
  return /*#__PURE__*/(0,jsx_runtime.jsx)(card/* default */.Z, {
    ...
    children: !loading && data.length === 0 ? /*#__PURE__*/(0,jsx_runtime.jsx)(empty/* default */.Z, {}) : /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "liteChartWrap",
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          ...
          options: [{
            label: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
                ...
                className: actionType === 'hours' ? 'text linkColor active' : 'text',
                children: [formatMessage({
                  id: 'chart_h',
                  defaultMessage: 'H'
                }), " "]
            ...
            label: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
                ...
                className: actionType === 'day' ? 'text linkColor active' : 'text',
                children: [formatMessage({
                  id: 'chart_d',
                  defaultMessage: 'D'
                }), " "]
            ...
            label: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
                ...
                className: actionType === 'week' ? 'text linkColor active' : 'text',
                children: formatMessage({
                  id: 'chart_w',
                  defaultMessage: 'W'
                })
            ...
            label: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
                ...
                className: actionType === 'month' ? 'text linkColor active' : 'text',
                children: formatMessage({
                  id: 'chart_m',
                  defaultMessage: 'M'
                })
      ...
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(components_area/* default */.Z, objectSpread2_default()(objectSpread2_default()({}, config), {}, {
        loading: loading,
...
function HomePage() {
  ...
  (0,react.useEffect)(function () {
    if (tokenArr.length > 0 && actionType === 'swap') {
      ...
      if (_find) {// setCurrentToken(_find)
      }
    }
  }, [tokenArr, actionType]);
