...
var fetchSaleInfo = /*#__PURE__*/function () {
  var _ref = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime_default()().mark(function _callee(params) {
    var res, chain, wallet, contract, ret, startAt, endAt, saleTokenAmount, marketValue, saleVolume, totalRaised, price;
    return regeneratorRuntime_default()().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 7:
            ...
            startAt = ret.startAt, endAt = ret.endAt, saleTokenAmount = ret.saleTokenAmount, marketValue = ret.marketValue, saleVolume = ret.saleVolume;
            totalRaised = (0,utils/* bigint2Number */.Sn)(saleVolume, 30);
            price = (0,utils/* bigint2Number */.Sn)(saleVolume, 30 + 8); // TODO hardCode 1e9 totalSupply ,10% for ifo
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            res[0] = {
              ...
              userBuyTokenAmount: userBuyTokenAmount.toString(),
...
function HomePage() {
  ...
  var MinimumReceive = (0,react.useMemo)(function () {
    if (inAmount && inToken) {
      return (Number(inAmount) * Number(inToken.userOraclePrice) / maxPrice).toFixed(2);
    }
  }, [inAmount, inToken]);
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(card/* default */.Z, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        gutter: [12, 12],
        children: OTInfo.map(function (_ref4) {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(row/* default */.Z, {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(col/* default */.Z, objectSpread2_default()(objectSpread2_default()({}, ProgressLayout), {}, {
          ...
          children: accountInfo && /*#__PURE__*/(0,jsx_runtime.jsx)(statistic/* default */.Z, {
            ...
            prefix: "$" // formatter={(value) => formatNumberToKMBT(Number(value), 2)}
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(InputCard/* default */.Z, {
              ...
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
                ...
                children: ["Balance: ", /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
                  ...
                  children: 1e8 - Number((saleInfo === null || saleInfo === void 0 ? void 0 : saleInfo.saleVolume) || 0)
                })]
              })]
            }) : '')), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              className: "btnWrap",
