...
function HomePage() {
  ...
  var _useState3 = (0,react.useState)('verified'),
      _useState4 = slicedToArray_default()(_useState3, 2),
      poolSelect = _useState4[0],
      setPoolSelect = _useState4[1];
  ...
  var _useState9 = (0,react.useState)(false),
      ...
      showDetail = _useState10[0],
      setShowDatail = _useState10[1];

  var _useState11 = (0,react.useState)(false),
      _useState12 = slicedToArray_default()(_useState11, 2),
      showNewPool = _useState12[0],
      setShowNewPool = _useState12[1];

  var _useState13 = (0,react.useState)(false),
      _useState14 = slicedToArray_default()(_useState13, 2),
      showEditLip = _useState14[0],
      setShowEditLip = _useState14[1];

  var _useState15 = (0,react.useState)(),
      _useState16 = slicedToArray_default()(_useState15, 2),
      editLipAction = _useState16[0],
      setEditLipAction = _useState16[1];

  var _useState17 = (0,react.useState)(),
      _useState18 = slicedToArray_default()(_useState17, 2),
      editLipActionPool = _useState18[0],
      setEditLipActionPool = _useState18[1]; // Borrow


  var _useState19 = (0,react.useState)(false),
      _useState20 = slicedToArray_default()(_useState19, 2),
      showBorrowAction = _useState20[0],
      setShowBorrowAction = _useState20[1];

  var _useState21 = (0,react.useState)('borrow'),
      _useState22 = slicedToArray_default()(_useState21, 2),
      borrowAction = _useState22[0],
      setBorrowAction = _useState22[1];

  var _useState23 = (0,react.useState)(),
      _useState24 = slicedToArray_default()(_useState23, 2),
      borrowActionTarget = _useState24[0],
      setBorrowActionTarget = _useState24[1];

  var _useState25 = (0,react.useState)(),
      _useState26 = slicedToArray_default()(_useState25, 2),
      borrowPopupProps = _useState26[0],
      setBorrowPopupProps = _useState26[1];

  var _useState27 = (0,react.useState)(),
      _useState28 = slicedToArray_default()(_useState27, 2),
      liqPopupProps = _useState28[0],
      setLiqPopupProps = _useState28[1]; //
    ...
    if (poolTokenExtList.length > 0) {
      ...
      poolTokenExtList.forEach(function (item) {
        var poolSize = item.poolSize,
            ...
            userOraclePrice = item.userOraclePrice,
            poolOsdRevenue = item.poolOsdRevenue,
            swapFee = item.swapFee,
            poolOsd = item.poolOsd;
        tvl += Number(poolSize);
        totalBorrowed += Number(poolDebt) * Number(userOraclePrice);
        totalOsdRevenue += Number(poolOsdRevenue);
        spot24Fees += Number(swapFee);
        totalPoolOsd += Number(poolOsd);
      });
      return {
        ...
        spot24Fees: spot24Fees,
        totalPoolOsd: totalPoolOsd
      };
    }
  }, [poolTokenExtList]);
  ...
  var _useState29 = (0,react.useState)(),
      ...
      Fees = _useState30[0],
      setFees = _useState30[1];

  var _useState31 = (0,react.useState)('0'),
      _useState32 = slicedToArray_default()(_useState31, 2),
      Volume24H = _useState32[0],
      setVolume24H = _useState32[1];

  var _useState33 = (0,react.useState)('0'),
      _useState34 = slicedToArray_default()(_useState33, 2),
      Fee24H = _useState34[0],
      setFee24H = _useState34[1];

  var _useState35 = (0,react.useState)('0'),
      _useState36 = slicedToArray_default()(_useState35, 2),
      UniqueAddr = _useState36[0],
      setUniqueAddr = _useState36[1];
  ...
  var getFees = (0,react.useCallback)( /*#__PURE__*/asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime_default()().mark(function _callee() {
    var _uniqueAddrRet, _yield$protocolFees, _yield$protocolFees2, ret, err;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,api/* getUniqueAddr */.Bv)(chain);

          case 3:
            _uniqueAddrRet = _context.sent;

            if (_uniqueAddrRet && _uniqueAddrRet.unique_address) {
              setUniqueAddr(_uniqueAddrRet.unique_address);
            }
  ...
  var totalOsdSupply = (0,react.useMemo)(function () {
    if (statisticData && osdData) {
      return (0,utils/* formatNumberToKMBT */.BF)(Number(statisticData.totalPoolOsd) + Number(osdData.totalSupply), 2);
    }

    return '0';
  }, [osdData, statisticData]);
  (0,useIntervalAsync/* default */.Z)(getFees, 15000);
  ...
  (0,react.useEffect)(function () {
    ...
    if (poolSelect !== 'all') {
      tmp = tmp.filter(function (item) {
        return poolSelect === 'verified' ? Boolean(item.icon) : !Boolean(item.icon);
      });
    }
    ...
    setList(tmp);
  }, [poolTokenExtList, serachWord, poolSelect]);
  ...
  var columns = [{
    ...
    render: function render(text, record) {
      var icon = record.icon,
          ...
          id = record.id,
          userOraclePrice = record.userOraclePrice;
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)(space/* default */.Z, {
                children: [/*#__PURE__*/(0,jsx_runtime.jsx)("a", {
                  className: "linkColor",
                  href: "".concat(chain === null || chain === void 0 ? void 0 : chain.exporerAccountUrl, "/").concat(id, "?network=").concat(chain === null || chain === void 0 ? void 0 : chain.network),
                  target: "_blank",
                  children: symbol
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsx)(NumberFormat/* default */.Z, {
              value: userOraclePrice,
              prefix: "$",
              precision: Number(userOraclePrice) >= 1 ? 2 : 3
            })
          })
        })]
      });
    ...
    title: /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
      children: [formatMessage({
        id: 'pools_th_borrowed'
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("br", {}), formatMessage({
        id: 'pools_th_borrow_apr'
      })]
    }),
    dataIndex: 'borrowed',
    key: 'borrowed',
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsx)(NumberFormat/* default */.Z, {
            value: poolRevenue,
            precision: 2,
            suffix: " ".concat(symbol)
          })
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "desc",
          children: /*#__PURE__*/(0,jsx_runtime.jsx)(NumberFormat/* default */.Z, {
            value: poolOsdRevenue,
            kmt: true,
            precision: 2,
            prefix: "$"
          })
    ...
    render: function render(text, record) {
      return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        }), (parseFloat(record.userDebt) > 0 || parseFloat(record.userTotalCol) > 0) && /*#__PURE__*/(0,jsx_runtime.jsxs)(es_button/* default */.Z, {
          onClick: function onClick(e) {
            e.stopPropagation();
            handleRepay(record);
          },
    ...
    title: /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
      children: [formatMessage({
        id: 'pools_th_liquidity'
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("br", {}), formatMessage({
        id: 'pools_th_your_lp_share'
      })]
    }),
    dataIndex: 'tokenId',
    key: 'liquidity',
    ...
    render: function render(text, record) {
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        ...
        }), parseFloat(userLpBalance) > 0 && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "lpRate",
          style: {
            fontSize: 13
          },
  ...
  var selectBefore = /*#__PURE__*/(0,jsx_runtime.jsxs)(es_select/* default */.Z, {
    value: poolSelect,
    style: {
      height: 40,
      lineHeight: 40
    ...
    onChange: function onChange(v) {
      return setPoolSelect(v);
    },
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Option, {
      value: "verified",
      children: formatMessage({
        id: 'pool_select_verified'
      })
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(Option, {
      value: "unVerified",
      children: formatMessage({
        id: 'pool_select_un_verified'
      })
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(Option, {
      value: "all",
      children: formatMessage({
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(row/* default */.Z, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(col/* default */.Z, objectSpread2_default()(objectSpread2_default()({}, statisticLayout), {}, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(statistic/* default */.Z, {
          ...
          value: (0,utils/* formatNumberToKMBT */.BF)(Number(statisticData === null || statisticData === void 0 ? void 0 : statisticData.spot24Fees) + Number(Fee24H), 2),
          prefix: "$",
          loading: !(statisticData !== null && statisticData !== void 0 && statisticData.spot24Fees)
        })
      })), /*#__PURE__*/(0,jsx_runtime.jsx)(col/* default */.Z, objectSpread2_default()(objectSpread2_default()({}, statisticLayout), {}, {
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(statistic/* default */.Z, {
          title: /*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(statistic/* default */.Z, {
          title: /*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
            ...
            children: formatMessage({
              id: "pools_h_osd_supply"
            })
          }),
          value: totalOsdSupply,
          prefix: "",
          loading: !totalOsdSupply
        })
      })), /*#__PURE__*/(0,jsx_runtime.jsx)(col/* default */.Z, objectSpread2_default()(objectSpread2_default()({}, statisticLayout), {}, {
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(statistic/* default */.Z, {
          title: /*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
