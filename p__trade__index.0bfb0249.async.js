...
// EXTERNAL MODULE: ./src/services/contract/index.ts + 72 modules
var contract = __webpack_require__(30013);
...
var Swap = function Swap(_ref) {
  ...
  var _useState11 = (0,react.useState)('0'),
      ...
      impact = _useState12[0],
      setImpact = _useState12[1];

  var inRef = (0,react.useRef)();

  var _useState13 = (0,react.useState)(),
      _useState14 = slicedToArray_default()(_useState13, 2),
      succRet = _useState14[0],
      setSuccRet = _useState14[1]; // update token
...
var Long = function Long(_ref) {
  ...
  }, [poolTokenExtList, osdData]); // const selectInList = useMemo(() => {
  ...
  var handleTokenChange = function handleTokenChange(_inToken, _outToken) {
  ...
  (0,react.useEffect)(function () {
    if (selectList.length > 0 && tokenPairs.length > 0 && positionList.length > 0 && !inToken && !outToken) {
      ...
      if (_inToken && _outToken) {
        handleTokenChange(_inToken, _outToken);
        setInToken(_inToken);
    ...
    if (selectList.length > 0 && tokenPairs.length > 0 && positionList.length > 0 && inToken && outToken) {
      handleTokenChange(inToken, outToken);
    }
  }, [selectList, tokenPairs, positionList, inToken, outToken]); // // update token
  // useEffect(() => {
  //     if (inToken) {
  //         const _find = selectList.find(item => item.id === inToken.id);
  //         if (_find) {
  //             setInToken(_find)
  //         }
  //     }
  //     if (outToken) {
  //         const _find = selectList.find(item => item.id === outToken.id);
  //         if (_find) {
  //             setOutToken(_find)
  //         }
  //     }
  ...
  var inAmountUSD = (0,react.useMemo)(function () {
    if (inAmount && curPair && curData) {
      return (Number(inAmount) + Number(curData._tradingFee)) * Number(curPair.userCollateralPrice);
    }
  ...
  var handleSelectChannge = function handleSelectChannge(token, selectType) {
    if (selectType === 'in') {
      var _pair = tokenPairs.find(function (pair) {
        return pair.collateralToken.toLowerCase() === token.id.toLowerCase() && pair.indexToken.toLowerCase() === (outToken === null || outToken === void 0 ? void 0 : outToken.id.toLowerCase());
      });

      if (!_pair) _pair = tokenPairs.find(function (pair) {
        return pair.collateralToken.toLowerCase() === token.id.toLowerCase();
      });
      if (!_pair) throw new Error('unKnown Error');

      var _outToken = selectOutList.find(function (token) {
        var _pair2;

        return token.id.toLowerCase() === ((_pair2 = _pair) === null || _pair2 === void 0 ? void 0 : _pair2.indexToken.toLowerCase());
      });
      ...
      var _pair3 = tokenPairs.find(function (pair) {
        return pair.collateralToken.toLowerCase() === (inToken === null || inToken === void 0 ? void 0 : inToken.id.toLowerCase()) && pair.indexToken.toLowerCase() === token.id.toLowerCase();
      });

      if (!_pair3) _pair3 = tokenPairs.find(function (pair) {
        return pair.indexToken.toLowerCase() === token.id.toLowerCase();
      });
      if (!_pair3) throw new Error('unKnown Error');

      var _inToken = selectInList.find(function (token) {
        var _pair4;

        return token.id.toLowerCase() === ((_pair4 = _pair3) === null || _pair4 === void 0 ? void 0 : _pair4.collateralToken.toLowerCase());
      });
          ...
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              return (0,contract/* increasePosition */.tu)({
                ...
                outToken: outToken,
                isLong: isLong,
                marginDelta: BigInt((0,utils/* amountRaw */.xo)(String(Number(inAmount) + Number(curData._tradingFee)), curPair.userCollateralTokenDecimal)),
                //curData.marginDelta ,
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)(FormButton/* default */.Z, {
        ...
        conditions: [{
          ...
          condition: !!inToken && !!curData && Number(inAmount) + Number(curData._tradingFee) > inToken.userTokenBalance,
          text: 'Low balance',
          type: 'primary',
          onClick: function onClick() {}
        }],
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(col/* default */.Z, {
        ...
        children: data && /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DescItem, {
            ...
            label: "tradingFee",
            children: /*#__PURE__*/(0,jsx_runtime.jsxs)(typography/* default.Text */.Z.Text, {
              children: [data.tradingFee, " ", collateralToken.symbol]
            })
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(DescItem, {
            label: "fundingFee",
            children: /*#__PURE__*/(0,jsx_runtime.jsxs)(typography/* default.Text */.Z.Text, {
              children: [data.fundingFee, " ", collateralToken.symbol]
            })
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(DescItem, {
            label: "Receive",
            children: /*#__PURE__*/(0,jsx_runtime.jsxs)(typography/* default.Text */.Z.Text, {
