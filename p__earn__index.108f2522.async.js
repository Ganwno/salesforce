...
;// CONCATENATED MODULE: ./src/assets/svg/ot.svg
  ...
  var data = {
    conf: {
      ...
      edit: [{
        ...
        align: 'center',
        render: function render(text, record) {
          var userAccountYield = record.userAccountYield;
          return /*#__PURE__*/(0,jsx_runtime.jsxs)(es_button/* default */.Z, {
            type: md ? 'link' : 'primary',
            disabled: parseFloat(record.userAccountStaked) <= 0,
            onClick: function onClick() {
              setWitndrawProp({
                amount: userAccountYield,
                onClose: function onClose() {
                  return setWitndrawProp(undefined);
                },
                show: true,
            ...
            children: [Number(userAccountYield) || 0, " OT"]
          });
        }
      }]
    },
