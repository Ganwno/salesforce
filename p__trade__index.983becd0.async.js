...
var Long = function Long(_ref) {
  ...
  var _useModel2 = (0,_umi_production_exports.useModel)('tradeTokenList'),
      setLongIndex = _useModel2.setLongIndex,
      longIndex = _useModel2.longIndex,
      setShortIndex = _useModel2.setShortIndex,
      shortIndex = _useModel2.shortIndex,
      longIndexArr = _useModel2.longIndexArr,
      shortIndexArr = _useModel2.shortIndexArr;

  var outToken, setOutToken;
  var selectOutList;

  if (isLong) {
    // const [outToken, setOutToken] = useState<API.BasicToken>();
    outToken = longIndex;
    setOutToken = setLongIndex;
    selectOutList = longIndexArr;
  } else {
    outToken = shortIndex;
    setOutToken = setShortIndex;
    selectOutList = shortIndexArr;
  }
  ...
  var _useModel3 = (0,_umi_production_exports.useModel)('future'),
      ...
      updateLimitOrder = _useModel3.updateLimitOrder;
  ...
  var _useState11 = (0,react.useState)(),
      _useState12 = slicedToArray_default()(_useState11, 2),
      curPair = _useState12[0],
      setCurPair = _useState12[1];

  var _useState13 = (0,react.useState)(),
      _useState14 = slicedToArray_default()(_useState13, 2),
      curPosition = _useState14[0],
      setCurrentPosition = _useState14[1];

  var _useState15 = (0,react.useState)('market'),
      _useState16 = slicedToArray_default()(_useState15, 2),
      tradeType = _useState16[0],
      setTradeType = _useState16[1];

  var _useState17 = (0,react.useState)(1.0),
      _useState18 = slicedToArray_default()(_useState17, 2),
      leverage = _useState18[0],
      _setLeverage = _useState18[1];

  var _useState19 = (0,react.useState)(),
      _useState20 = slicedToArray_default()(_useState19, 2),
      curData = _useState20[0],
      setCurData = _useState20[1];

  var inRef = (0,react.useRef)();

  var _useState21 = (0,react.useState)(),
      _useState22 = slicedToArray_default()(_useState21, 2),
      succRet = _useState22[0],
      setSuccRet = _useState22[1];

  var _useState23 = (0,react.useState)(0),
      _useState24 = slicedToArray_default()(_useState23, 2),
      targetPrice = _useState24[0],
      setTargetPrice = _useState24[1];

  var _useState25 = (0,react.useState)(0),
      _useState26 = slicedToArray_default()(_useState25, 2),
      tpPrice = _useState26[0],
      setTpPrice = _useState26[1];

  var _useState27 = (0,react.useState)(0),
      _useState28 = slicedToArray_default()(_useState27, 2),
      slPrice = _useState28[0],
      setSlPrice = _useState28[1];

  var _useState29 = (0,react.useState)(false),
      _useState30 = slicedToArray_default()(_useState29, 2),
      tpsl = _useState30[0],
      _setTPSL = _useState30[1];
  ...
  var selectInList = (0,react.useMemo)(function () {
    ...
    return [];
  }, [selectList, tokenPairs, outToken]); // 状态提升
  ...
  var handleSelectChannge = function handleSelectChannge(token, selectType) {
    if (selectType === 'in') {
      ...
      if (((_outToken2 = outToken) === null || _outToken2 === void 0 ? void 0 : _outToken2.id) === token.id) {
        setOutToken(undefined);
      }
...
function HomePage() {
  ...
  var currentChartPair = (0,react.useMemo)(function () {
    if (currentToken && tokenPairs.length && actionType !== 'swap') {
      var _find = tokenPairs.find(function (item) {
        return item.indexToken.toLowerCase() === currentToken.id;
      });

      if (_find) return _find;
    }
  }, [currentToken, tokenPairs, actionType]);
