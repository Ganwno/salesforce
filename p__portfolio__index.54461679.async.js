...
function HomePage() {
  ...
  var _useState5 = (0,react.useState)([]),
      ...
      DepositsTokenList = _useState6[0],
      setDepositsTokenList = _useState6[1];
  ...
  var calcLPValue = (0,react.useCallback)( /*#__PURE__*/asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime_default()().mark(function _callee() {
    var _list, newList, i, token, _yield$calcRemoveLiqI, _yield$calcRemoveLiqI2, ret, err, LPValue;

    return regeneratorRuntime_default()().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (!(!chain || !wallet || !osdData)) {
              _context.next = 2;
              break;
            }
          ...
          case 2:
            _list = poolTokenExtList.filter(function (item) {
          ...
          case 5:
            ...
            return (0,contract/* calcRemoveLiqIn */.kT)({
              ...
              wallet: wallet,
              token: token,
              amount: Number(token.userLpBalance),
              osdData: osdData
            });

          case 9:
            _yield$calcRemoveLiqI = _context.sent;
            _yield$calcRemoveLiqI2 = slicedToArray_default()(_yield$calcRemoveLiqI, 2);
            ret = _yield$calcRemoveLiqI2[0];
            err = _yield$calcRemoveLiqI2[1];

            if (ret) {
              LPValue = Number(ret.outToken) * Number(token.userOraclePrice) + Number(ret.outOsd);
              newList.push(objectSpread2_default()(objectSpread2_default()({}, token), {}, {
  ...
  var columns = [{
    ...
    render: function render(_, record) {
      ...
      collaterals.forEach(function (_ref2) {
    ...
    render: function render(_, record) {
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            className: "symbol",
            children: [" ", Number(userLpBalance).toFixed(4), " ", lpSymbol, " | ", userLpRate, "%"]
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            className: "fullname",
            children: ["$", lpValue]
          })]
  ...
  var _useState25 = (0,react.useState)('Wallet balance'),
      _useState26 = slicedToArray_default()(_useState25, 2),
      value = _useState26[0],
      setValue = _useState26[1];

  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "porfilePage animation-slide-bottom",
