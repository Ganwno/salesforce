...
var TokenSelect = function TokenSelect(_ref) {
  ...
  var fetchTokenList = (0,react.useCallback)( /*#__PURE__*/asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime_default()().mark(function _callee() {
    var _tokenList, _yield$fetchTokenInfo, onchainList;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 8;
            return (0,contract/* fetchTokenInfo */.eX)([{
              id: searchWord
            }], chain, wallet);

          case 8:
            _yield$fetchTokenInfo = _context.sent;
            onchainList = _yield$fetchTokenInfo.tokenList;
