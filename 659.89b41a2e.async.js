  ...
  var combineConditions = (0,react.useMemo)(function () {
    if (wallet) {
      return [{
        ...
        condition: !wallet.isCorrectChain,
        text: formatMessage({
          id: 'switch_network'
        }),
        type: 'primary',
...
var InputCard = function InputCard(_ref) {
  var currentToken = _ref.currentToken,
      ...
      header = _ref$header === void 0 ? /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {}) : _ref$header,
      ...
      _ref$tokenSelectProps = _ref.tokenSelectProps,
      tokenSelectProps = _ref$tokenSelectProps === void 0 ? {} : _ref$tokenSelectProps,
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [header, /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(input_number/* default */.Z, {
        ...
        }), /*#__PURE__*/(0,jsx_runtime.jsx)(TokenSelect/* default */.Z, objectSpread2_default()(objectSpread2_default()({}, tokenSelectProps), {}, {
          tokenList: tokenList,
...
var commomUseTokens = ["0x3355df6d4c9c3035724fd0e3914de96a5a83aaf4", "0xd0ea21ba66b67be636de1ec4bd9696eb8c61e9aa", "0x9bd8c192a74566546f8998a29c1e0ca10a47c359", "0x2F96F4397AdDdF9C2eeB5233a29556BE26eb9450"];
...
var TokenSelect = function TokenSelect(_ref) {
  var show = _ref.show,
      ...
      _ref$searchToken = _ref.searchToken,
      searchToken = _ref$searchToken === void 0 ? false : _ref$searchToken,
  ...
  var _useState5 = (0,react.useState)([]),
      _useState6 = slicedToArray_default()(_useState5, 2),
      commomUseTokensList = _useState6[0],
      setCommomUseTokensList = _useState6[1];

  var fetchTokenList = (0,react.useCallback)( /*#__PURE__*/asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime_default()().mark(function _callee() {
    var _tokenList, _commomUseTokensList, _yield$getBulkTokenIn, _yield$getBulkTokenIn2, ret, item;

    return regeneratorRuntime_default()().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _tokenList = tokenList.filter(function (item) {
              return (0,utils/* searchBasicToken */.y6)(item, searchWord);
            }); // if(/^0x[0-9a-fA-F]{40}$/.test(searchWord)){
            //     _tokenList=_tokenList.filter(item=>!item.icon)
            // }

            if (position === 'swap' && !/^0x[0-9a-fA-F]{40}$/.test(searchWord)) {
              _tokenList = _tokenList.filter(function (item) {
                return !!item.icon;
              });
            }

            _commomUseTokensList = tokenList.filter(function (item) {
              return commomUseTokens.includes(item.id);
            });
            setCommomUseTokensList(_commomUseTokensList);
          ...
          case 8:
            if (!(chain && wallet && searchWord && searchToken)) {
              _context.next = 17;
              break;
            }
          ...
          case 11:
            _context.next = 13;
            return (0,pools/* getBulkTokenInfo */.Lc)({
              chain: chain,
              wallet: wallet,
          ...
          case 13:
            _yield$getBulkTokenIn = _context.sent;
            _yield$getBulkTokenIn2 = slicedToArray_default()(_yield$getBulkTokenIn, 1);
            ret = _yield$getBulkTokenIn2[0];

            // if (onchainList.length > 0) {
            //     setList(onchainList)
            // }
            if (ret && ret[0]) {
              item = objectSpread2_default()(objectSpread2_default()({}, ret[0]), {}, {
                id: ret[0].tokenAddress,
                liquidity: '',
                tokenId: ret[0].tokenAddress,
                icon: '',
                iconLp: '',
                lpSymbol: '',
                userOraclePriceLabel: '',
                userTokenBalanceLabel: '',
                userOraclePrice: '',
                userTokenBalanceUSDLabel: ''
              });
              setList([item]);
            }
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(ResponPopup/* default */.Z, {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        spinning: tokenList.length === 0,
        children: [type === 'token' && /*#__PURE__*/(0,jsx_runtime.jsx)(space/* default */.Z, {
          className: "commonUse",
          size: 10,
          style: {
            paddingBottom: 20
          },
          children: commomUseTokensList.map(function (item) {
          ...
          children: list.map(function (item) {
            return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
                ...
                children: [/*#__PURE__*/(0,jsx_runtime.jsx)(TokenIcon/* default */.Z, {
                  ...
                  children: [/*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
                    ...
                    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(space/* default */.Z, {
                      children: [type === 'token' ? item.symbol : item.lpSymbol, !item.icon && /*#__PURE__*/(0,jsx_runtime.jsx)(tag/* default */.Z, {
                        color: "#BB6BD9",
                        children: formatMessage({
                          id: 'unverified'
                        })
              ...
              }), rightContent ? rightContent : type !== 'pairs' && /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
                className: "right",
                children: [/*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
                  className: "balanceToken",
                  children: type === 'lpToken' ? item.userLpBalance : item.userTokenBalanceLabel
                }), type === 'token' && /*#__PURE__*/(0,jsx_runtime.jsxs)(typography/* default.Text */.Z.Text, {
