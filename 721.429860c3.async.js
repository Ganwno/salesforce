...
const TextArea_TextArea = /*#__PURE__*/react.forwardRef((_a, ref) => {
  ...
  const textArea = /*#__PURE__*/react.createElement(rc_textarea_es, Object.assign({}, (0,omit/* default */.Z)(props, ['allowClear']), {
...
const generatorTooltipPresetColor = token => {
  ...
  return presetColors/* PresetColors.reduce */.i.reduce((previousValue, currentValue) => {
