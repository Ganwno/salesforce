...
var IFOSvg = function IFOSvg(_ref5) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("path", {
      d: "M0.7803 6.86067L4.14026 3.50071C4.32693 3.31404 4.54692 3.18071 4.80025 3.10071C5.05358 3.02071 5.31358 3.00738 5.58024 3.06071L6.62023 3.28071C5.90024 4.13403 5.33358 4.90736 4.92025 5.60068C4.50692 6.29401 4.10693 7.134 3.72027 8.12065L0.7803 6.86067ZM4.88025 8.68065C5.18691 7.72066 5.60344 6.814 6.12984 5.96068C6.65676 5.10736 7.29356 4.30736 8.04022 3.56071C9.21353 2.38739 10.5535 1.5106 12.0602 0.930337C13.5668 0.350611 14.9735 0.174079 16.2801 0.400743C16.5068 1.70739 16.3335 3.11405 15.7601 4.62069C15.1868 6.12734 14.3135 7.46733 13.1402 8.64065C12.4068 9.37397 11.6068 10.0108 10.7402 10.551C9.87353 11.0908 8.96021 11.5139 8.00022 11.8206L4.88025 8.68065ZM10.4002 6.28068C10.7069 6.58734 11.0836 6.74067 11.5306 6.74067C11.977 6.74067 12.3535 6.58734 12.6602 6.28068C12.9668 5.97401 13.1202 5.59722 13.1202 5.15029C13.1202 4.70389 12.9668 4.32736 12.6602 4.0207C12.3535 3.71404 11.977 3.56071 11.5306 3.56071C11.0836 3.56071 10.7069 3.71404 10.4002 4.0207C10.0935 4.32736 9.94019 4.70389 9.94019 5.15029C9.94019 5.59722 10.0935 5.97401 10.4002 6.28068ZM9.84019 15.9006L8.56021 12.9606C9.54686 12.5739 10.3903 12.1739 11.0906 11.7606C11.7903 11.3473 12.5668 10.7806 13.4202 10.0606L13.6202 11.1006C13.6735 11.3673 13.6602 11.6307 13.5802 11.891C13.5002 12.1507 13.3668 12.3739 13.1802 12.5606L9.84019 15.9006ZM2.06029 11.2406C2.52695 10.774 3.09361 10.5372 3.76027 10.5302C4.42692 10.5238 4.99358 10.754 5.46025 11.2206C5.92691 11.6873 6.16024 12.2539 6.16024 12.9206C6.16024 13.5873 5.92691 14.1539 5.46025 14.6206C5.12692 14.9539 4.57039 15.2406 3.79067 15.4806C3.01041 15.7206 1.93362 15.9339 0.560303 16.1206C0.746967 14.7472 0.960298 13.6739 1.2003 12.9006C1.44029 12.1273 1.72696 11.5739 2.06029 11.2406Z",
      fill: "url(#".concat(name, ")")
    }), /*#__PURE__*/(0,jsx_runtime.jsx)("defs", {
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)("linearGradient", {
        id: name,
...
var Grid = function Grid(_ref6) {
  var startColor = _ref6.startColor,
      endColor = _ref6.endColor,
      name = _ref6.name;
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    style: {
      fill: 'currentcolor'
...
var TabIcon = function TabIcon(_ref7) {
  var name = _ref7.name,
      active = _ref7.active,
      defalutColor = _ref7.defalutColor;
  var colors = {
  ...
  if (name === 'icon-ifo') {
    return /*#__PURE__*/(0,jsx_runtime.jsx)(IFOSvg, objectSpread2_default()({}, colors));
  }
...
// EXTERNAL MODULE: ./src/config/index.ts + 5 modules
var config = __webpack_require__(10875);
// EXTERNAL MODULE: ./src/services/contract/index.ts + 3 modules
var contract = __webpack_require__(8227);
;// CONCATENATED MODULE: ./src/layouts/components/index.less
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/layouts/components/SelectLang.tsx
...
/* harmony default export */ var SelectLang = (function () {
  ...
  var content = /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "selectLangPopover",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
      className: "langItem left",
      style: {
        color: currentLang === 'English' ? colorPrimary : colorText
      },
      onClick: function onClick() {
        (0,_umi_production_exports.setLocale)('en-US', false);
      },
      children: "English"
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Text */.Z.Text, {
      className: "langItem right",
      style: {
        color: currentLang === '中文' ? colorPrimary : colorText
      },
      onClick: function onClick() {
        (0,_umi_production_exports.setLocale)('zh-CN', false);
      },
      children: "\u7B80\u4F53\u4E2D\u6587"
    })]
  });
...
;// CONCATENATED MODULE: ./src/assets/svg/moon.svg
...
const SvgMoon = (props) => /* @__PURE__ */ React.createElement("svg", __spreadValues({ width: 20, height: 20, fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props), /* @__PURE__ */ React.createElement("path", { d: "M18.956 12.627a.566.566 0 0 0-.797-.655 6.06 6.06 0 0 1-6.875-9.818.566.566 0 0 0-.343-.973 9.084 9.084 0 1 0 8.015 11.446Z", fill: "#181D2C", stroke: "#181D2C", strokeWidth: 1.131, strokeLinecap: "round", strokeLinejoin: "round" }));

/* harmony default export */ var moon = ("data:image/svg+xml;base64,");

;// CONCATENATED MODULE: ./src/assets/svg/sun.svg
var sun_defProp = Object.defineProperty;
var sun_getOwnPropSymbols = Object.getOwnPropertySymbols;
var sun_hasOwnProp = Object.prototype.hasOwnProperty;
var sun_propIsEnum = Object.prototype.propertyIsEnumerable;
var sun_defNormalProp = (obj, key, value) => key in obj ? sun_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var sun_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (sun_hasOwnProp.call(b, prop))
      sun_defNormalProp(a, prop, b[prop]);
  if (sun_getOwnPropSymbols)
    for (var prop of sun_getOwnPropSymbols(b)) {
      if (sun_propIsEnum.call(b, prop))
        sun_defNormalProp(a, prop, b[prop]);
    }
  return a;
};

const SvgSun = (props) => /* @__PURE__ */ React.createElement("svg", sun_spreadValues({ width: 22, height: 22, fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props), /* @__PURE__ */ React.createElement("path", { d: "M11 .1a1 1 0 0 1 1 1v1.8a1 1 0 1 1-2 0V1.1a1 1 0 0 1 1-1ZM11 15.5a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM12 19.1a1 1 0 1 0-2 0v1.8a1 1 0 1 0 2 0v-1.8ZM3.291 3.29a1 1 0 0 1 1.414 0L5.983 4.57A1 1 0 1 1 4.57 5.983L3.291 4.705a1 1 0 0 1 0-1.414ZM17.431 16.017a1 1 0 0 0-1.414 1.414l1.278 1.278a1 1 0 1 0 1.414-1.414l-1.277-1.278ZM.1 11a1 1 0 0 1 1-1h1.8a1 1 0 0 1 0 2H1.1a1 1 0 0 1-1-1ZM19.1 10a1 1 0 0 0 0 2h1.8a1 1 0 1 0 0-2h-1.8ZM5.983 16.017a1 1 0 0 1 0 1.414L4.705 18.71a1 1 0 1 1-1.414-1.414l1.278-1.278a1 1 0 0 1 1.414 0ZM18.71 4.705a1 1 0 0 0-1.415-1.414l-1.278 1.278a1 1 0 1 0 1.415 1.414l1.277-1.278Z", fill: "#fff" }));

/* harmony default export */ var sun = ("data:image/svg+xml;base64,");
...
var footerlinks = [{
  link: 'http://discord.gg/onchaintrade',
  label: 'Discord',
  ...
  link: 'https://github.com/onchaintrade',
  label: 'Code',
...
var layout_Layout = function Layout(_ref) {
  ...
  var _useModel = (0,_umi_production_exports.useModel)('initModel'),
      ...
      setContentWidth = _useModel.setContentWidth,
  ...
  var _useModel2 = (0,_umi_production_exports.useModel)('chain'),
      ...
      isModalOpen = _useModel2.loginModalShow,
      setIsModalOpen = _useModel2.setLoginModalShow;
  ...
  var _useState3 = (0,react.useState)(false),
      ...
      GridOpen = _useState4[0],
      setGridOpen = _useState4[1];

  var pageWidth = (0,react.useMemo)(function () {
    if (ContentWidth === 'Fluid') return '100vw';
    return '1300px';
  }, [ContentWidth]);
  ...
  var handleSwitchChain = function handleSwitchChain(chainId) {
    if (chainId === '0x2') {
      if (location.href.indexOf('onchain.trade') > -1) {
        location.replace(location.href.replace(location.host, 'aptos.onchain.trade').replace(location.search, '') + '?chainId=0x2&theme=' + currentTheme);
      }
    } else {
      switchChain(chainId);
    }
    ...
    return {
      ...
      label: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("img", {
          src: currentTheme === 'light' ? item.darkIcon || item.icon : item.icon,
          className: "icon ".concat(item.key),
          alt: ""
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DescItem, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(input_number/* default */.Z, {
          ...
          onChange: function onChange(value) {
            if (typeof value === 'number') setMaxSlippageInfo(value);
          }
        })
  ...
  var handleJoinBeta = function handleJoinBeta() {
    location.replace('https://beta.onchain.trade');
  };
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Paragraph */.Z.Paragraph, {
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsx)(typography/* default.Link */.Z.Link, {
            className: "account",
            href: (chain === null || chain === void 0 ? void 0 : chain.exporerAccountUrl) + "/" + (wallet === null || wallet === void 0 ? void 0 : wallet.account) + '?network=' + (chain === null || chain === void 0 ? void 0 : chain.network),
            target: "_blank",
            style: {
              lineHeight: "36px",
              paddingRight: 27
        ...
        spinning: tokenList.length === 0 && initLoading,
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(es_layout, {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(row/* default */.Z, {
      ...
      style: {
        ...
        zIndex: 1,
        display: 'flex',
        padding: screens.md ? '0 30px' : '0 15px',
        ...
        children: [screens.md && /*#__PURE__*/(0,jsx_runtime.jsx)(col/* default */.Z, {
          ...
          children: menus.map(function (item) {
            return /*#__PURE__*/(0,jsx_runtime.jsx)(_umi_production_exports.Link, {
              to: item.path,
              className: pathname.indexOf(item.path) > -1 ? 'active item' : "item",
          ...
          size: 15,
          children: [chain && chain.name === 'arbitrum Mainet' && /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z, {
            type: "primary",
            ...
            children: !wallet.isConnected ? /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z, {
              type: "primary",
          ...
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(SelectLang, {}), /*#__PURE__*/(0,jsx_runtime.jsx)(popover/* default */.Z, {
...
/* harmony default export */ var layouts_layout = (layout_Layout);
...
function layouts_Layout() {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(config_provider/* default */.ZP, {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsx)(layouts_layout, {
