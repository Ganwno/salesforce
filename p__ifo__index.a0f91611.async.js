...
// EXTERNAL MODULE: ./src/services/contract/common.ts
var common = __webpack_require__(18983);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            console.log(allowClaim, 'allowClaimallowClaim');
            res[0] = {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 7;
            return (0,common/* approve */.d)(chain, wallet, inToken.id, contract.address, bignumber/* BigNumber.from */.O$.from(_amountRaw));
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsx)(row/* default */.Z, {
            ...
            children: saleInfo && /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
              children: !saleInfo.isSaleEnd ? /*#__PURE__*/(0,jsx_runtime.jsx)(col/* default */.Z, {
                ...
                children: /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z, {
                  type: "primary",
                  disabled: !(saleInfo !== null && saleInfo !== void 0 && saleInfo.isSaleEnd) || !(saleInfo !== null && saleInfo !== void 0 && saleInfo.isAllowC) || accountInfo && accountInfo.userContribution === 0 || (accountInfo === null || accountInfo === void 0 ? void 0 : accountInfo.isWithdraw) || wallet && !wallet.isConnected || wallet && !wallet.isCorrectChain,
