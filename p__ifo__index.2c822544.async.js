...
var fetchSaleInfo = /*#__PURE__*/function () {
  var _ref = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime_default()().mark(function _callee(params) {
    var res, SaleTokenDec, OTDec, chain, wallet, contract, ret, startAt, endAt, saleTokenAmount, marketValue, saleVolume, capMarketValue, totalRaised, _saleTokenAmount, _price, _minMarketValue, _maxMarketValue, minPrice, price, saleBalance;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            _price = (0,utils/* bigint2Number */.Sn)(saleVolume, SaleTokenDec + 8); //saleVolume/_saleTokenAmount;
