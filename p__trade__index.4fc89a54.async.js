...
function HomePage() {
  ...
  (0,react.useEffect)(function () {
    if (currentChart && tokenPairs.length && actionType !== 'swap') {
      ...
      var _pairsSelectTokens = tokenPairs.map(function (item) {
        return item.indexToken.toLowerCase();
      });

      var _pairs = poolTokenExtList.filter(function (item) {
        return _pairsSelectTokens.includes(item.id);
      });
              ...
              children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(row/* default */.Z, {
                ...
                children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(col/* default */.Z, objectSpread2_default()(objectSpread2_default()({}, trade_ChartItemLayout), {}, {
                  ...
                  children: [/*#__PURE__*/(0,jsx_runtime.jsx)(TokenIcon/* default */.Z, {
                    ...
                    className: "symbol",
                    children: [(currentChart === null || currentChart === void 0 ? void 0 : currentChart.symbol) || defaultChart, actionType !== 'swap' ? '/USD' : '', " "]
                  }), /*#__PURE__*/(0,jsx_runtime.jsx)(DownOutlined/* default */.Z, {})]
                })), actionType !== 'swap' && /*#__PURE__*/(0,jsx_runtime.jsx)(components_ChartHeader, {
